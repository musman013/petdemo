...
public class VisitsManagerTest {
	...
	public void findVisitsById_IdIsNotNullAndIdExists_ReturnVisits() {
		...
		Mockito.<Optional<VisitsEntity>>when(_visitsRepository.findById(anyLong())).thenReturn(dbVisits);
	...
	public void findVisitsById_IdIsNotNullAndIdDoesNotExist_ReturnNull() {
	    ...
	    Mockito.<Optional<VisitsEntity>>when(_visitsRepository.findById(anyLong())).thenReturn(Optional.empty());
