...
public class OwnersManagerTest {
	...
	public void findOwnersById_IdIsNotNullAndIdExists_ReturnOwners() {
		...
		Mockito.<Optional<OwnersEntity>>when(_ownersRepository.findById(anyLong())).thenReturn(dbOwners);
	...
	public void findOwnersById_IdIsNotNullAndIdDoesNotExist_ReturnNull() {
	    ...
	    Mockito.<Optional<OwnersEntity>>when(_ownersRepository.findById(anyLong())).thenReturn(Optional.empty());
