...
public class TypesManagerTest {
	...
	public void findTypesById_IdIsNotNullAndIdExists_ReturnTypes() {
		...
		Mockito.<Optional<TypesEntity>>when(_typesRepository.findById(anyLong())).thenReturn(dbTypes);
	...
	public void findTypesById_IdIsNotNullAndIdDoesNotExist_ReturnNull() {
	    ...
	    Mockito.<Optional<TypesEntity>>when(_typesRepository.findById(anyLong())).thenReturn(Optional.empty());
