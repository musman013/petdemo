...
public class PetsManagerTest {
	...
	public void findPetsById_IdIsNotNullAndIdExists_ReturnPets() {
		...
		Mockito.<Optional<PetsEntity>>when(_petsRepository.findById(anyLong())).thenReturn(dbPets);
	...
	public void findPetsById_IdIsNotNullAndIdDoesNotExist_ReturnNull() {
	    ...
	    Mockito.<Optional<PetsEntity>>when(_petsRepository.findById(anyLong())).thenReturn(Optional.empty());
