...
public class VetsManagerTest {
	...
	public void findVetsById_IdIsNotNullAndIdExists_ReturnVets() {
		...
		Mockito.<Optional<VetsEntity>>when(_vetsRepository.findById(anyLong())).thenReturn(dbVets);
	...
	public void findVetsById_IdIsNotNullAndIdDoesNotExist_ReturnNull() {
	    ...
	    Mockito.<Optional<VetsEntity>>when(_vetsRepository.findById(anyLong())).thenReturn(Optional.empty());
