...
import com.fastcode.demopet.domain.types.*;
...
public class TypesAppServiceTest {
	...
	public void findTypesById_IdIsNotNullAndIdDoesNotExist_ReturnNull() {
		...
		Mockito.when(_typesManager.findById(anyLong())).thenReturn(null);
	...
	public void findTypesById_IdIsNotNullAndIdExists_ReturnTypes() {
		...
		Mockito.when(_typesManager.findById(anyLong())).thenReturn(types);
