...
import com.fastcode.demo.domain.authorization.rolepermission.IRolepermissionManager;
import com.fastcode.demo.domain.model.QRolepermissionEntity;
import com.fastcode.demo.domain.model.RolepermissionEntity;
import com.fastcode.demo.domain.model.RolepermissionId;
import com.fastcode.demo.domain.authorization.permission.IPermissionManager;
import com.fastcode.demo.domain.model.PermissionEntity;
import com.fastcode.demo.domain.authorization.role.IRoleManager;
...
import com.fastcode.demo.security.JWTAppService;
...
public class RolepermissionAppService implements IRolepermissionAppService {
		...
		if(input.getPermissionId()!=null && input.getRoleId()!=null){
			...
			if(foundPermission!=null && foundRole!=null) {
				if(!checkIfPermissionAlreadyAssigned(foundRole, foundPermission))
				{
					...
					return mapper.roleAndPermissionEntityToCreateRolepermissionOutput(foundRole, foundPermission);
				}
			}
		}
	...
	public void delete(RolepermissionId rolepermissionId ) {
		...
		RoleEntity foundRole = _roleManager.findById(rolepermissionId.getRoleId());
		PermissionEntity foundPermission = _permissionManager.findById(rolepermissionId.getPermissionId());
