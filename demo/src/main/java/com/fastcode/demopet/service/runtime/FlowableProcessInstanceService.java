 ...
 */
package com.fastcode.demopet.service.runtime;

import com.fastcode.demopet.application.processmanagement.FlowableIdentityService;
import com.fastcode.demopet.model.runtime.CreateProcessInstanceRepresentation;
...
public class FlowableProcessInstanceService {
    ...
    public ProcessInstanceRepresentation getProcessInstance(String processInstanceId, HttpServletResponse response) {
        ...
        if (!permissionService.hasReadPermissionOnProcessInstance(flowableIdentityService.getFlowableUser(), processInstance, processInstanceId)) {
    ...
    public ProcessInstanceRepresentation startNewProcessInstance(CreateProcessInstanceRepresentation startRequest) {
        ...
        if (!permissionService.canStartProcess(flowableIdentityService.getFlowableUser(), processDefinition)) {
