...
import com.fastcode.demopet.model.component.SimpleContentTypeMapper;
import com.fastcode.demopet.model.runtime.ContentItemRepresentation;
...
public abstract class AbstractRelatedContentResource {
    ...
    public ResultListDataRepresentation getContentItemsForTask(String taskId) {
        permissionService.validateReadPermissionOnTask(flowableIdentityService.getFlowableUser(), taskId);
    ...
    public ResultListDataRepresentation getContentItemsForCase(String caseInstanceId) {
        permissionService.hasReadPermissionOnCase(flowableIdentityService.getFlowableUser(), caseInstanceId);
    ...
    public ResultListDataRepresentation getContentItemsForProcessInstance(String processInstanceId) {
        ...
        if (!permissionService.hasReadPermissionOnProcessInstance(flowableIdentityService.getFlowableUser(), processInstanceId)) {
    ...
    public ContentItemRepresentation createContentItemOnTask(String taskId, MultipartFile file) {
        User user = flowableIdentityService.getFlowableUser();
    ...
    public void deleteContent(String contentId, HttpServletResponse response) {
        ...
        if (!permissionService.hasWritePermissionOnRelatedContent(flowableIdentityService.getFlowableUser(), contentItem)) {
    ...
    public ContentItemRepresentation getContent(String contentId) {
        ...
        if (!permissionService.canDownloadContent(flowableIdentityService.getFlowableUser(), contentItem)) {
