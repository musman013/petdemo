...
public class TypesController {
    ...
    FindTypesByIdOutput output = _typesAppService.findById(Long.valueOf(id));
    ...
    _typesAppService.delete(Long.valueOf(id));
    }
	...
	public ResponseEntity<UpdateTypesOutput> update(@PathVariable String id, @RequestBody @Valid UpdateTypesInput types) {
	    FindTypesByIdOutput currentTypes = _typesAppService.findById(Long.valueOf(id));
	    ...
	    return new ResponseEntity(_typesAppService.update(Long.valueOf(id),types), HttpStatus.OK);
	}
