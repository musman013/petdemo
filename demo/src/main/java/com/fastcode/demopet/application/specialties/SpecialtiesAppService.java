...
import com.fastcode.demopet.domain.specialties.ISpecialtiesManager;
import com.fastcode.demopet.domain.model.QSpecialtiesEntity;
...
public class SpecialtiesAppService implements ISpecialtiesAppService {
	...
	@Autowired
	private ISpecialtiesMapper mapper;
	...
	@Transactional(propagation = Propagation.REQUIRED)
	public UpdateSpecialtiesOutput update(Long  specialtiesId, UpdateSpecialtiesInput input) {
	...
	@Transactional(propagation = Propagation.REQUIRED)
	public void delete(Long specialtiesId) {
	...
	public FindSpecialtiesByIdOutput findById(Long specialtiesId) {
